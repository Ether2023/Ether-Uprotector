...
{
    MethodDefUser method = new("OrangeHacked", new MethodSig(CallingConvention.Default, 0, Module.CorLibTypes.Void), MethodAttributes.Public | MethodAttributes.Static);
