...
2. Use the parameter `MonoObfus` to encrypt your assembly
   ...
   for exzample:
   Ether-Uprotector.exe D:\Myproject\Assembly-Csharp.dll MonoObfus
   ~~~
3. Enjoy Safe！ xD
4. If you want to use the ObfusFunc function to obtain more powerful confusion，Please carefully read `How to use ObfusFunc & Rules to note`
5. For Unity users, we provide UnityPackage for you to use(Download it in **Release**)
...
## How to use **Ether_Obfuscator** and deal with problems
