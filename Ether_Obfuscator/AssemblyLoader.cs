...
namespace Ether_Obfuscator
{
    public class AssemblyLoader
    {
        ...
        public AssemblyLoader(string Assembly)
        {
            ...
            OutputPath = System.IO.Path.GetDirectoryName(Path) + "\\[EtherObfuscated]" + System.IO.Path.GetFileName(Path);
            LoadAssembly();
            LoadModuleDefMD();
            //LoadDependencies();
        ...
        public void Save()
        {
            ...
            Assembly.Write(System.IO.Path.GetDirectoryName(Path) + "\\[EtherObfuscated]" + System.IO.Path.GetFileName(Path), opts);
