...
public class ObfusDLLs : IPostBuildPlayerScriptDLLs, IPreprocessBuildWithReport , IPostprocessBuildWithReport
{
    ...
    private static EtherConfig config;
    public int callbackOrder { get { return 0; } }
    public void OnPreprocessBuild(BuildReport report)
    {
        config = AssetDatabase.LoadAssetAtPath<EtherConfig>("Assets/Plugins/Ether/Config.asset");
...
public class _OZ_Obfuscator
{
    ...
    public void Obfusdll()
    {
        ...
        config = AssetDatabase.LoadAssetAtPath<EtherConfig>("Assets/O&ZProtector/Config.asset");
